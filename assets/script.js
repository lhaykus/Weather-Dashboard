    ...
    $.ajax({
        ...
        function getForecast() {
           ...
           //         $("#showForecast").html(forecast);
                    ...
                    for (let i = 0; i < results[i].lenght; i+=8) {
                        console.log(results[i].dt_txt);

                    return  "<img src=' https://openweathermap.org/img/wn/" + results.weather[0].icon + ".png'> " +
                         "<h3>Temperature: " + results.main.temp + "°F </h3>" +
                             //Displaying the humidity 
                             "<h3>Humidity: " + results.main.humidity + "% </h3>"
